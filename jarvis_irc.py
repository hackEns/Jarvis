...
while True:
    ...
    if len(t) > 1:
        ...
        if prefix('HELP'):
            ...
            ans("Jarvis est un bot doté de capacités dépassant à la fois " +
                "l'entendement et les limites d'irc. Prenez donc garde a " +
                "toujours rester poli avec lui car bien qu'aucune intention " +
                "malsaine ne lui a été volontairement inculquée,")
